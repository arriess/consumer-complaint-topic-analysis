...
A planned WordNet lemmatization step could not be reproduced because the required NLTK resources were unavailable. I replaced it with deterministic offline preprocessing. The sample is limited to incorrect credit-reporting complaints, so findings should not be generalized to all CFPB complaints.
